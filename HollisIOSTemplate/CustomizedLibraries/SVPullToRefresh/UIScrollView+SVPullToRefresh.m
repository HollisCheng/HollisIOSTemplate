...
- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler lastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey position:(SVPullToRefreshPosition)position {
    ...
    if(!self.pullToRefreshView) {
        ...
        view.lastUpdatedTimeKey = lastUpdatedTimeKey;
    }
    
}

//- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler {
//    [self addPullToRefreshWithActionHandler:actionHandler lastUpdatedTimeKey:nil position:SVPullToRefreshPositionTop];
//}
//
//- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler lastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey {
//    [self addPullToRefreshWithActionHandler:actionHandler lastUpdatedTimeKey:lastUpdatedTimeKey position:SVPullToRefreshPositionTop];
//}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    if([keyPath isEqualToString:@"contentOffset"]) {
        if ([self.lastUpdatedTimeKey length] > 0) {
            [self setSubtitle:getLastUpdatedTimeDisplay(self.lastUpdatedTimeKey) forState:SVPullToRefreshStateAll];
        }
